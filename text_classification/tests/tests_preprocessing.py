...
import pytest
import helper_tests
from preprocessing import open_documents, documents_pages_to_dataframe
...
def test_pdf_to_text(input_and_output):
    ...
    extracted_string = open_documents(
